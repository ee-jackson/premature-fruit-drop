...
m1 <- lme4::glmer(proportion_abscised ~ seedpred_pres + (year|sp), family= binomial, data = fruitDatFull, weights = total_seeds)
summary(m1)
...
m2 <- lme4::glmer(proportion_abscised ~ seedpred_pres + (1|sp), family= binomial, data = fruitDat, weights = total_seeds)
summary(m2) #effect of seedpredationrate is significatly positive but very small
